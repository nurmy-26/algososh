  ...
  return (
    <main className={`${styles.content} ${extraClass}`}>
      ...
      <div className={styles.cards_box}>
        <Link data-cy="recursion" className={styles.link} to="/recursion">
          <div className={`${styles.card} ${styles.string}`} />
        </Link>
        <Link data-cy="fibonacci" className={styles.link} to="/fibonacci">
          <div className={`${styles.card} ${styles.fibonacci}`} />
        </Link>
        <Link data-cy="sorting" className={styles.link} to="/sorting">
          <div className={`${styles.card} ${styles.arr}`} />
        </Link>
        <Link data-cy="stack" className={styles.link} to="/stack">
          <div className={`${styles.card} ${styles.stack}`} />
        </Link>
        <Link data-cy="queue" className={styles.link} to="/queue">
          <div className={`${styles.card} ${styles.queue}`} />
        </Link>
        <Link data-cy="list" className={styles.link} to="/list">
